          ...
          {pending.length === 0 ? (
            ...
            <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              {pending.map(s => {
                ...
                return (
                  <div key={s.id} className="p-4 bg-slate-50/50 dark:bg-[#0a1628]/60 rounded-2xl border border-dashed border-slate-200 dark:border-[#1a2f4a]">
                    ...
                    <div className="space-y-1.5 text-xs mb-3 ml-13">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-semibold text-slate-700 dark:text-slate-200 truncate max-w-[180px]">{s.department.name}</span>
                      </div>
                      <div className="flex items-center justify-between">
