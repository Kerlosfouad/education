    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      {activeTab === 'table' && (
        <div className="bg-white dark:bg-[#0f1f38] rounded-3xl border border-slate-100 dark:border-[#1a2f4a] shadow-sm overflow-hidden">
          {/* Filter Bar */}
          <div className="p-4 border-b border-slate-100 dark:border-[#1a2f4a] bg-slate-50/50 dark:bg-[#0a1628]/60">
            <div className="flex flex-wrap gap-3 items-center">
              <select value={filterDept} onChange={e => { setFilterDept(e.target.value); setFilterLevel(''); }}
                className="px-3 py-2 bg-white dark:bg-[#0d1e35] border border-slate-200 dark:border-[#1a2f4a] rounded-xl text-sm text-slate-700 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500/20">
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-slate-50 dark:bg-[#0a1628]/60">
                    ...
                    <th className="p-3 text-xs font-bold text-slate-500 dark:text-slate-400 text-left border-b border-slate-100 dark:border-[#1a2f4a] min-w-[140px]">Department</th>
                    <th className="p-3 text-xs font-bold text-slate-500 dark:text-slate-400 text-center border-b border-slate-100 dark:border-[#1a2f4a] min-w-[80px]">Level</th>
                    {sessions.map(s => (
                  ...
                  {filteredStudents.map(student => {
                    ...
                    return (
                      <tr key={student.id} className="hover:bg-slate-50/50 dark:hover:bg-[#0a1628]/30 transition-colors">
                        ...
                        <td className="p-3 text-sm text-slate-600 dark:text-slate-300 font-medium">{student.department.name}</td>
                        <td className="p-3 text-center">
                          <span className="text-xs font-bold text-slate-700 dark:text-slate-200 bg-slate-100 dark:bg-[#0a1628]/60 px-2 py-1 rounded-full">
