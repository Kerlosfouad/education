...
function AuthErrorContent() {
  ...
  const getErrorMessage = (errorCode: string | null) => {
    switch (errorCode) {
      ...
      case 'Account pending approval': return 'Your account is pending approval.';
      case 'Account suspended': return 'Your account has been suspended.';
      case 'Account rejected': return 'Your registration has been rejected.';
